    ...
    <form @submit.prevent="handleSubmit" class="register-form">
      ...
      <section class="form-section" :class="{ 'error-section': hasBasicInfoErrors }">
        ...
        <div class="form-group">
          ...
          <div class="input-button-group">
            <input id="userId" v-model="formData.userId" type="text" required minlength="6"
              :class="{ 'error': errors.userId || errors.isDuplicatedId }" />
            <button type="button" class="check-button" @click="checkDuplicateId"
        ...
        <div class="form-group">
          ...
          <input id="password" v-model="formData.password" type="password" required minlength="8" maxlength="16"
        ...
        <div class="form-group">
          ...
          <input id="passwordConfirm" v-model="formData.passwordConfirm" type="password" required
        ...
        <div class="form-group">
          ...
          <input id="userBirth" v-model="formData.userBirth" type="date" required max="2099-12-31" />
        </div>
        ...
        <div class="form-group">
          ...
          <div class="radio-group">
            ...
            <label class="radio-label">
              <input type="radio" v-model="formData.gender" :value="true" required />
              <span>남성</span>
            </label>
            <!-- 여성 선택 라디오 버튼 -->
            <label class="radio-label">
              <input type="radio" v-model="formData.gender" :value="false" required />
              <span>여성</span>
            </label>
          </div>
        </div>
      ...
      <section class="form-section" :class="{ 'error-section': hasChildInfoErrors }">
        ...
        <div class="form-group">
          ...
          <div class="radio-group">
            <label class="radio-label">
              <input type="radio" v-model="hasChildren" :value="true" required @change="handleHasChildrenChange" />
              <span>있음</span>
            </label>
            <label class="radio-label">
              <input type="radio" v-model="hasChildren" :value="false" required />
              <span>없음</span>
            </label>
          </div>
        ...
        <div v-if="hasChildren" class="children-section">
          <div v-for="(kid, index) in formData.kids" :key="index" class="child-info">
            <div class="child-header">
              <h4>자녀 {{ index + 1 }}</h4>
              <button type="button" @click="removeChild(index)" class="remove-button">
                삭제
              </button>
            </div>
            ...
            <div class="form-group">
              ...
              <input :id="'kidBirth' + index" v-model="kid.kidBirth" type="date" required />
            </div>
            ...
            <div class="form-group">
              ...
              <div class="radio-group">
                <label class="radio-label">
                  <input type="radio" v-model="kid.kidGender" :value="true" required />
                  <span>남자</span>
                </label>
                <label class="radio-label">
                  <input type="radio" v-model="kid.kidGender" :value="false" required />
                  <span>여자</span>
                </label>
              </div>
            </div>
          ...
          <!-- 자녀 추가 버튼 -->
          <button type="button" @click="addChild" class="add-child-button">
            + 자녀 추가
          </button>
        </div>
      </section>
      ...
      <section class="form-section" :class="{ 'error-section': hasContactInfoErrors }">
        ...
        <div class="form-group">
          ...
          <input id="email" v-model="formData.email" type="email" required
            pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" :class="{ 'error': errors.email }" />
        ...
        <div class="form-group">
          ...
          <input id="mobile" v-model="formData.mobile" type="tel" required pattern="[0-9]{10,11}"
        ...
        <div class="form-group">
          ...
          <div class="input-button-group">
            <input id="addrZipcode" v-model="formData.addrZipcode" type="text" readonly required />
        ...
        <div class="form-group">
          ...
          <input id="addrMain" v-model="formData.addrMain" type="text" readonly required />
        </div>
        ...
        <div class="form-group">
          ...
          <input id="addrDetail" v-model="formData.addrDetail" type="text" required />
        </div>
      </section>
      ...
      <section class="form-section" :class="{ 'error-section': hasConsentErrors }">
        ...
        <div class="consent-all">
          <label class="consent-label">
            <input type="checkbox" v-model="allConsent" @change="handleAllConsent" />
        ...
        <div class="consent-group">
          ...
          <div class="consent-item">
            <div class="consent-header" @click="toggleTerms('tos')">
              <label class="consent-label">
                <input type="checkbox" v-model="formData.tosConsent" required @change="updateAllConsent" />
          ...
          <div class="consent-item">
            <div class="consent-header" @click="toggleTerms('privacy')">
              <label class="consent-label">
                <input type="checkbox" v-model="formData.privacyConsent" required @change="updateAllConsent" />
          ...
          <div class="consent-item">
            <div class="consent-header" @click="toggleTerms('location')">
              <label class="consent-label">
                <input type="checkbox" v-model="formData.locConsent" @change="updateAllConsent" />
          ...
          <div class="consent-item">
            <div class="consent-header" @click="toggleTerms('cookie')">
              <label class="consent-label">
                <input type="checkbox" v-model="formData.cookieConsent" @change="updateAllConsent" />
      ...
      <div class="submit-section">
        <button type="submit" class="submit-button" :disabled="isSubmitting || !idCheckPassed">
